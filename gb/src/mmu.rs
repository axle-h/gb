...
mod tests {
    ...
    mod cgb {
        ...
        fn compat() -> MMU {
            MMU::new(crate::test_fixtures::POKERED, Model::Cgb).unwrap()
        }
        ...
        fn color_mode_follows_the_cartridge_header() {
            ...
            assert_eq!(MMU::from_rom(crate::test_fixtures::POKERED).unwrap().color_mode(), ColorMode::Dmg);
        ...
        fn cgb_registers_are_unmapped_without_cgb_features() {
            ...
            for mut mmu in [MMU::from_rom(crate::test_fixtures::POKERED).unwrap(), compat()] {
        ...
        fn a_dmg_save_state_does_not_blank_a_compatibility_mode_screen() {
            ...
            let dmg = MMU::from_rom(crate::test_fixtures::POKERED).unwrap();
